"""
Dateiname: extracting_datapoints_pi.py
...
F = 50
dt = 0.25
timepoints = [0.25, 0.75]  # Beispielsweise 4s und 12s
...
strain_0, strain_1, strain_2, strain_3, strain_4, strain_5, strain_6, strain_7 = h_fns.read_data_from_txt_adafruit(filepath)
...
fs = 1000       # Abtastrate in Hz (1/0.05s = 20Hz)
