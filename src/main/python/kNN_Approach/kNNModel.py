...
data = pd.read_csv('gesamt_simulations_auswertung_edit_k=9.csv')
...
X_train, X_test, y_train, y_test, indices_train, indices_test = train_test_split(X, y, data.index, test_size=0.02, random_state=42)
